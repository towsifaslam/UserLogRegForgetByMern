...
//    console.log(user)
   ...
   successRespnse(res,{statusCode:200,message:'successfully Sign in', payload:{userWithourPass}})
...
const userLogout = async(req,res,next)=>{
    ...
    return successRespnse(res,{statusCode:202,message:'user logouted successfully'})
    } catch (error) {
